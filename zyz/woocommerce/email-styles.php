...
// Load colors.
$bg              = get_option( 'woocommerce_email_background_color' ); // Predefined #EDEDED
$body            = get_option( 'woocommerce_email_body_background_color' ); // Predefined #f7f7f7
$base            = get_option( 'woocommerce_email_base_color' ); // Predefined #38c994
$base_text       = wc_light_or_dark( $base, '#202020', '#ffffff' );
$text            = get_option( 'woocommerce_email_text_color' ); // Predefined #555555
