...
// Load colors.
$bg              = get_option( 'woocommerce_email_background_color' ); // Predefined #fafafa
$body            = get_option( 'woocommerce_email_body_background_color' ); // Predefined #ffffff
$base            = get_option( 'woocommerce_email_base_color' ); // Predefined #ef7249
$base_text       = wc_light_or_dark( $base, '#202020', '#ffffff' );
$text            = get_option( 'woocommerce_email_text_color' ); // Predefined #555E5E
