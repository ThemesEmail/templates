...
$body            = get_option( 'woocommerce_email_body_background_color' ); // Predefined #fafafa
$base            = get_option( 'woocommerce_email_base_color' ); // Predefined #4fc6dc
$base_text       = wc_light_or_dark( $base, '#202020', '#ffffff' );
$text            = get_option( 'woocommerce_email_text_color' ); // Predefined #7f7f7f
