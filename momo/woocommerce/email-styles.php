...
// Load colors.
$bg              = get_option( 'woocommerce_email_background_color' ); // Predefined #FFFFFF
$body            = get_option( 'woocommerce_email_body_background_color' ); // Predefined #DCEAF5
$base            = get_option( 'woocommerce_email_base_color' ); // Predefined #FB9E6B
$base_text       = wc_light_or_dark( $base, '#202020', '#ffffff' );
$text            = get_option( 'woocommerce_email_text_color' ); // Predefined #62779A
